...
-- Define varios banners como strings multilínea
local banners = {
  [[
   ,    /),
  (( -.((_))  _,)
...
local header = banners[math.random(#banners)]
...
return {
  {
    ...
    opts = {
      ...
      dashboard = {
        preset = {
          layout = {
            -- width = 2.0, -- usa el 100% del ancho de la ventana
            -- min_width = 200, -- ajusta este número según el ancho de tu banner
          },
          keys = {
